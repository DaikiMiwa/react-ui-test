...
screens:
  ...
  calendar-log:
    ...
    layout: "Centered 430px by 820px phone frame with shared header, a raised month calendar, and date-context content that changes automatically: past days show body/water plus actual editors, today shows body/water plus direct input links, and future days show the plan panel."
...
- 画面は Workout / Meal と同じ `phone-frame` を使い、ヘッダー、月カレンダー、日付文脈に応じた本文、日別メモの順に配置する。過去日と今日には体重/水分の入力カードを置き、未来日は予定カードだけを表示する。
